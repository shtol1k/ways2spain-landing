...
async function getItemsFromPreferences(payload, user) {
    const savedPreferences = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$payloadcms$2f$next$2f$dist$2f$utilities$2f$getPreferences$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPreferences"])('dashboard-layout', payload, user.id, user.collection);
