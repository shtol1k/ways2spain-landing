...
const features = [
  ...
  },
  {
    ...
    description: "Оптимізована процедура без зайвих затримок. Чіткі терміни на кожному етапі.",
  },
  {
    icon: Shield,
    title: "Легальність та безпека",
    description: "Офіційний ВНЖ з правом працювати віддалено. Повна відповідність законодавству.",
  },
  {
    icon: Users,
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Персональний супровід із перевіреними партнерами. Експертність без офіціозу.
          </p>
        </div>
